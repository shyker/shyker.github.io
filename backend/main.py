...
DIALOGUE_DATA = {
    ...
    "friends_click":["我的朋友们","友链环节"],
    "3906_click":['大帅！室长！',"我已经默认3906保研了","一位脱离了低级趣味的科幻迷","怀念厕所时日"],
    "zenus10_click":["教会了我许多，真的","其本人与该海报神似","给个design-flag","未曾谋面"],
    "cty_click":["cty可不可以发点美好的东西（我不讨厌）","cty教我后端"],
    ...
    "Aununo_click":["how are you today","亦师亦友","when you flow,life follows","let it be","很大程度上，两位甘式朋友改变了我的人生，Aununo是其中一位"],
    "shenshen_click":["你老公是gay是不是","大学燊"],
